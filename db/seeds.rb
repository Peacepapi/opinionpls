...
Question.create(title: "What was your favorite cartoon?", user_id: 1, category_id:5, choices_attributes:[
	{option: "Lorem ipsum t, consectetur adipiscing elit"},
	{option: "Lorem iectetur adipiscing elit"},
	{option: "Lorem ipsum dolor sit adipiscing elit"}])
Question.create(title: "How many pairs of shoes do you own?", user_id: 2, category_id:2, choices_attributes:[
	{option: "Lorem ipsum t, consectetur adipiscing elit"},
	{option: "Lorem iectetur adipiscing elit"},
	{option: "Lorem ipsum dolor sit adipiscing elit"}])
...
Question.create(title: "What is one thing that you would like to change about the world?", user_id: 4, category_id:6, choices_attributes:[
	...
	{option: "Lorem iectetur adipiscing elit"},
	{option: "Lorem ipsum dolor sit adipiscing elit"}])
Question.create(title: "If you were the opposite gender for one day, what would you do?", user_id: 6, category_id:2, choices_attributes:[
	{option: "Lorem ipsum t, consectetur adipiscing elit"},
	{option: "Lorem iectetur adipiscing elit"},
	{option: "Lorem ipsum dolor sit adipiscing elit"}])
